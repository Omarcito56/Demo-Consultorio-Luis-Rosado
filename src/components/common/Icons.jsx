...
export const WhatsAppIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2zm5.78 14.28c-.24.68-1.2 1.25-1.68 1.33-.45.07-1.04.1-3.02-.72-2.53-1.05-4.16-3.62-4.29-3.79-.12-.17-1.02-1.35-1.02-2.58 0-1.23.64-1.84.87-2.09.23-.25.5-.31.67-.31.17 0 .34 0 .49.01.16.01.37-.06.58.44.22.52.74 1.82.81 1.96.07.14.12.31.02.5-.09.19-.14.31-.28.47-.14.16-.29.35-.42.47-.14.14-.29.3-.12.59.16.29.73 1.2 1.57 1.95 1.08.96 1.99 1.26 2.28 1.4.29.14.46.12.63-.07.17-.19.74-.86.94-1.16.2-.29.4-.24.67-.14.28.1 1.77.83 2.07.98.3.15.5.23.57.35.07.12.07.72-.17 1.4z"/>
  </svg>
);
...
export const StethoscopeIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M9 12.5v2a4 4 0 0 0 4 4h1a4 4 0 0 0 4-4v-1.5"></path>
    <circle cx="18" cy="11" r="2"></circle>
    <line x1="3" y1="3" x2="6" y2="3"></line>
    <line x1="12" y1="3" x2="15" y2="3"></line>
  </svg>
);
...
export const LayoutDashboardIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
